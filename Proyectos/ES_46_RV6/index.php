...
<p>Antes de resolverlo, audita todo el grafo y rechaza ciclos, auto-dependencias, referencias inexistentes, nodos duplicados y nodos declarados sin hecho o regla. Los nodos válidos que no intervienen en el objetivo se muestran como aviso informativo.</p>
<p>Una repetición idéntica se informa como redundancia; sólo las declaraciones o definiciones incompatibles se rechazan. La publicación funciona siempre en modo estricto: ningún pendiente puede aprobarse como resultado final.</p>
</div>
</details>
<?php endif; ?>
<?php endif; ?>
